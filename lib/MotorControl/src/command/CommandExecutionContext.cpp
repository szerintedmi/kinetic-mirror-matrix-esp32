...
const MotorController& CommandExecutionContext::controller() const {
  return controller_;
}

bool CommandExecutionContext::thermalLimitsEnabled() const {
  return thermal_limits_enabled_;
}
...
int& CommandExecutionContext::defaultSpeed() {
  return default_speed_sps_;
}
int& CommandExecutionContext::defaultAccel() {
  return default_accel_sps2_;
}
...
bool CommandExecutionContext::inBatch() const {
  return in_batch_;
}
bool CommandExecutionContext::batchInitiallyIdle() const {
  return batch_initially_idle_;
}
